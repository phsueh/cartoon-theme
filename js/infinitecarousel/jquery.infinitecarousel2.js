...
(function($){
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			{
				$(obj).append('<div id="textholder'+randID+'_'+i+'" class="textholder" style="position:absolute;padding-left:40px;width:'+imgWidth+'px;bottom:0px;margin-bottom:'+-(imgHeight*o.textholderHeight+containerBorder)+'px;"><span></span></div>');
				...
				$('#textholder'+randID+'_'+i).height(imgHeight*o.textholderHeight).css; //if i want color do this ({'backgroundColor':'#FFF','opacity':'0.5'}) between .css and ; 
				html = '<div class="minmax" id="minmax'+randID+'_'+i+'" style="width:8px;height:8px;position:absolute;top:1px;right:10px;cursor:pointer;background:none;</div>';
